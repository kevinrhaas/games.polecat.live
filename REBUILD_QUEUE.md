...
## Queue
1. **huckfinn-raft** — 4/5 steer-dodge → **Oregon-Trail-style river journey sim**: branching stops, supplies/trust economy, help-Jim moral choices; the river map gates real branches.
2. **journeycenter-earth** — 5/5 dodge → **Verne descent resource-sim**: ration air/rope/water, branching descent routes on a vertical strata map (turn-based survival).
3. **annegreen-gables** — 4/5 fall-catchers → **cozy life-sim / dialogue visual-novel**: imagination & social scrapes as branching conversation.
4. **pride-prejudice** — 5 chapters, only 2 real mechanics → **Regency dating-sim**: reputation/affection meters + a minuet rhythm beat + a letter-writing word puzzle; branching dialogue.
